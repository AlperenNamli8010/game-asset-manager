...
?>
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
Şimdi sırada CRUD'un C - Create (Oluşturma) işlemi var. Bu sayfada, giriş yapmış kullanıcının kendi oyun projeleri için sisteme yeni bir dijital varlık (örneğin bir arka plan müziği veya bir karakter modeli) eklemesini sağlayacağız.

Ana proje klasörünün içine veri-ekle.php adında yeni bir dosya oluştur ve aşağıdaki kodları yapıştır:
